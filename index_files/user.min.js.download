...
$('.format-selector').click(function(e){e.stopPropagation();bookFormatsDropdownOpen($(this).data('id'));});$(".see-more-btn").click(function(e){let dataID=$(this).data('id');e.stopPropagation();$(".book-description[data-id='"+dataID+"']").css("max-height","none");$(this).hide();});$('.nft-slider-wrapper').slick({accessibility:true,arrows:true,dots:true,infinite:true,speed:300,slidesToShow:1,fade:true,autoplay:false,}).on('setPosition');$(window).scroll(function(){if($(window).scrollTop()>150){$('.shortcut__component').removeClass('hidden');$('.shortcut__component').addClass('active');}
